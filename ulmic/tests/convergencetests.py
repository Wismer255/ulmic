...
file_medium = 'convergencetest.hdf5'
...
#         in both gauges with dephasing. """
    ...
    #     print(medium.check_real_spacer_eigenstate(0,1))
...
#         pulses.variables[0]['omega'] = 1.6/au.eV
#         time = np.linspace(-20.0/au.fs,120.0/au.fs,8000)
#         ulmi = UltrafastLightMatterInteraction(medium,pulses,time,step_size='auto',options={'time_step_min':1e-3,'relative_error_tolerance':1e-7})
#         ulmi.gamma = 0.1
#         result = ulmi.run_stepwise(gauge='lg',equation='lvn')
#         file_result = os.path.join(test_dir,'result_1d_lg_dephasing_convergence_pub2_800k.hdf5')
